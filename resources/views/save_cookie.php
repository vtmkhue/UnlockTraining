  <form id="frmSaveCookie" action="" method="post">
    ...
    <div class="col-5 col-s-12">
      <img id="showImage" height="183" width="275" title="Your chosen" alt="Your chosen" 
        <?php echo $showImage;
        if (!empty($imageLoad)) {
          $image = "../resources/images/" . $imageLoad . ".jpg";
